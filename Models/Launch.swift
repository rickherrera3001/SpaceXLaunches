...
// Modelo que representa la estructura de datos de la API
//Model representing the data structure of the API

import Foundation

// MARK: - RocketElement
struct RocketElement: Encodable {
